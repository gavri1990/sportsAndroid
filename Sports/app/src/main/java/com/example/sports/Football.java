...
public class Football extends AppCompatActivity
{
    ...
    DatabaseReference myRef = database.getReference("Texts/Football");
    ...
    {
        super.onStop();
        Menu.mediaPlayer1.pause(); //παύση αναπαραγωγής σε αρχική Activity
        Menu.mediaPlayer1.seekTo(0);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Now playing: Uefa Champions League Anthem", Toast.LENGTH_LONG).show();
    }
