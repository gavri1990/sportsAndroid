...
public class Volleyball extends AppCompatActivity
{
    ...
    DatabaseReference myRef = database.getReference("Texts/Volleyball");
    ...
    {
        super.onStop();
        Menu.mediaPlayer4.pause(); //παύση αναπαραγωγής σε αρχική Activity
        Menu.mediaPlayer4.seekTo(0);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Now playing: CEV Eurovolley 2019 Official Song", Toast.LENGTH_LONG).show();
    }
